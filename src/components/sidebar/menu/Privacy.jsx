...
export default function Privacy({ modals, handleModal }) {
    ...
    useEffect(() => {
        setPrivacy(auth ? auth.privacy : "");
    }, [])

    return (
        <div className={`${modals.privacy ? "right-0" : "-right-full"} absolute top-0 z-30 size-full bg-primary select-none transition-all duration-300`}>
