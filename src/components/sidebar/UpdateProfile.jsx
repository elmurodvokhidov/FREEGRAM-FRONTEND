        ...
        <div className={`${isUpdate ? "right-0 z-30" : "-right-full -z-30"} absolute top-0 size-full bg-primary transition-all duration-300`}>
            ...
            <main className="flex flex-col items-center gap-4 py-6 mt-14">
                ...
                <form className="w-full" onSubmit={handleUpdate}>
                    ...
                    <button
                        disabled={isLoading}
                        className="w-[92%] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm mx-4 py-2.5 mb-1 disabled:bg-blue-800"
                    >
