...
export default function UserComponent({ modals, handleModal, search }) {
    ...
    const handleDeleteUser = () => {
        console.log("User deleted:", contextMenu.userId);
    ...
    return (
        <section className="overflow-y-auto" onClick={handleCloseContextMenu}>
                ...
                users?.length > 0 ?
                    users.map(user => (
                        <div
                            ...
                            onMouseEnter={() => handleCloseContextMenu()}
            ...
            {contextMenu.visible && (
                <div
                    className="flex flex-col fixed left-4 top-16 p-2 shadow-lg rounded-lg backdrop-blur-3xl"
                ...
                >
                    ...
                    <button onClick={handleDeleteUser} className="flex items-center gap-4 px-4 py-1 rounded hover:bg-secondary transition-all text-red-500">
